...
<li>0.25 is the <strong>intercept</strong> (β₀): the predicted value of y when x = 0.</li>
<li>2.41 is the <strong>slope</strong> (β₁): the change in y per one-unit increase in x.</li>
</ul>`,
    },
    {
      type: "callout",
      ...
      html: `<p><strong>What does β₁ = 2.41 mean?</strong><br>For each additional cigarette per adult per day, CHD mortality is expected to increase by 2.41 units.</p>
...
<p>The intercept (β₀ = 0.25) is the predicted CHD mortality when cigarettes per day = 0. This interpretation only makes sense if x = 0 is within the data range. If the minimum smoking rate in the dataset is 5 cigarettes/day, x = 0 is an extrapolation and β₀ is a mathematical artifact, not a meaningful prediction.</p>`,
    },
    {
      type: "interactive",
