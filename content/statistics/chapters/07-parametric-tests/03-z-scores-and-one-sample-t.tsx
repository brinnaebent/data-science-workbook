...
<p>A positive z-score means the point is above the mean; negative means below. A z-score of zero means exactly at the mean. Z-scores assume your data is normally distributed and are sensitive to outliers (which inflate σ, deflating everything's z-score).</p>
...
<ul><li>H₀: The sample mean equals the benchmark.</li><li>H₁: The sample mean differs from the benchmark.</li></ul>
<p><strong>Test statistic:</strong></p>
<p style="text-align:center">$$t = \\frac{\\bar{x} - \\mu}{s/\\sqrt{n}}$$</p>
<p>where x̄ is the sample mean, μ is the benchmark, s is the sample standard deviation, and n is the sample size.</p>
...
<ul>
<li>H₀: New algorithm average = 4.5</li>
<li>H₁: New algorithm average ≠ 4.5</li>
</ul>
