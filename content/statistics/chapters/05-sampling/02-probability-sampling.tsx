...
const probabilitySampling: Section = {
  ...
  blocks: [
    ...
    {
      type: "text",
      html: `<p><strong>Simple Random Sampling</strong></p><p>Every member of the population has an equal chance of being selected. The conceptually cleanest method and the gold standard when feasible. Use this as your default when the population is well-defined and accessible.</p>`,
    },
    {
      type: "text",
      html: `<p><strong>Stratified Sampling</strong></p><p>Divide the population into subgroups (strata) and randomly sample from each. Use this when you have known subgroups whose distributions matter — sampling equal numbers from each demographic group, or sampling from each class in a classification problem so your test set isn't all majority class.</p>
